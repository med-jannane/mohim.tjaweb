...
function ImageCarousel() {
  ...
  const images = [
    ...
    '/img/by @vector_hamza _ 🇲🇦 wallpaper.jpeg',
    '/img/Cigogne (1).jpeg',
    '/img/Cigogne.jpeg',
    ...
    '/img/téléchargement (1).jpeg',
    '/img/téléchargement (10).jpeg',
    '/img/téléchargement (2).jpeg',
    '/img/téléchargement (3).jpeg',
    '/img/téléchargement (4).jpeg',
    '/img/téléchargement (5).jpeg',
